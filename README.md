...
### Step 2: Install AIReceptionist

1. Locate the downloaded `.exe` file (usually in your Downloads folder).  
2. Double-click the file to start the installation.  
3. Follow the simple setup wizard steps. You can keep the default options.  
4. Once installation finishes, the program will be ready to run.
...
## ⚙️ How to Set Up AIReceptionist
